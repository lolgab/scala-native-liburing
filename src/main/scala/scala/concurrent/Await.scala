...
//     while (System.nanoTime() < time + atMost.toNanos && !awaitable
//              .asInstanceOf[Future[T]]
//              .isCompleted) Loop.default.run(RunMode.NoWait)
...
//     while (System.currentTimeMillis() < time + atMost.toMillis && !awaitable
//              .asInstanceOf[Future[T]]
//              .isCompleted) Loop.default.run(RunMode.NoWait)
